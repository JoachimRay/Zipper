...
- Add a `run` script for Windows and Linux that invokes the Maven command.
- Configure packaging (jlink/jpackage) to create a native installer.
- Add CLI support to compress/decompress via command line (without the GUI).

---

Updated README generated by an assistant; tell me if you'd like more examples or packaging instructions.
